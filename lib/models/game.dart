...
class Game {
  ...
  factory Game.fromJson(Map<String, dynamic> json) {
    ...
    json['description']!=null?game.description =json['description']:game.description ="";
    json['enabled']!=null?game.enabled =json['enabled']:game.enabled =true;
    json['rating']!=null?game.rating =json['rating']:game.rating =0;
    json['playerCount']!=null?game.playerCount =json['playerCount']:game.playerCount =0;
